...
import requests
from bs4 import BeautifulSoupimport json
import re
import time
from datetime import datetime
import requests
...
def scrape_salto_courses():
    """Schraapt SALTO European Training Calendar met de originele ruime element-zoekers."""
    print("Starten met schrapen van SALTO-Youth...")
    courses = []
    today_str = datetime.now().strftime("%Y-%m-%d")
    
    # Gebruik de originele browse URL met target_group=NL
    ...
    while True:
        ...
        try:
            ...
            # Zoek op de oorspronkelijke ruime manier naar kaarten/rijen op SALTO
            ...
            print(f"SALTO Pagina {page}: {page_items_count} projecten gevonden.")
